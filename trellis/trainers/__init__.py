...
__attributes = {
    ...
    # xrh added: Editing
    'EditingFlowMatchingTrainer': 'flow_matching.flow_matching',
    'EditingImageConditionedFlowMatchingCFGTrainer': 'flow_matching.flow_matching',
    'EditingSparseFlowMatchingTrainer': 'flow_matching.sparse_flow_matching',
    'EditingImageConditionedSparseFlowMatchingCFGTrainer': 'flow_matching.sparse_flow_matching',
}
...
if __name__ == '__main__':
    ...
    # xrh added: Editing
    from .flow_matching.flow_matching import (
        EditingFlowMatchingTrainer,
        EditingImageConditionedFlowMatchingCFGTrainer,
    )
