...
__attributes = {
    ...
    # xrh: editing
    'EditingSparseStructureFlowModelV0': 'editing_sparse_structure_flow',
    'EditingSparseStructureFlowModel': 'editing_sparse_structure_flow',
    'EditingSLatFlowModel': 'editing_structured_latent_flow',
    'EditingElasticSLatFlowModel': 'editing_structured_latent_flow',
}
...
if __name__ == '__main__':
    ...
    # xrh: editing
    from .editing_sparse_structure_flow import EditingSparseStructureFlowModel