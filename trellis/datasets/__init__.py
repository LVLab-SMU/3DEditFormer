...
__attributes = {
    ...
    # xrh added: Editing
    'EditingSparseStructureLatent': 'editing.sparse_structure_latent',
    'EditingImageConditionedSparseStructureLatent': 'editing.sparse_structure_latent',
    'EditingSLat': 'editing.structured_latent',
    'EditingImageConditionedSLat': 'editing.structured_latent',
}
...
if __name__ == '__main__':
    ...
    from .editing.sparse_structure_latent import (
        EditingSparseStructureLatent,
        EditingImageConditionedSparseStructureLatent,
    )